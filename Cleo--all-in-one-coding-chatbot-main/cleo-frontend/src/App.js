  ...
  return (
    <div className="container">
      ...
      <div className="video-section">
        <div className="video"><h3>My Video</h3><video ref={myVideo} playsInline muted autoPlay /></div>
        <div className="video"><h3>Partner's Video</h3>{callAccepted && !callEnded && <video ref={userVideo} playsInline autoPlay />}</div>
      </div>
      ...
      <div className="chat-section">
        <h3>Chat</h3>
        <div className="chat-box">{messages.map((msg, index) => (<p key={index}><strong>{msg.sender}</strong>: {msg.message}</p>))}</div>
      ...
      <div className="ai-chat-section">
        ...
        <div className="chat-box">{aiMessages.map((msg, index) => (<p key={index}><strong style={{ color: msg.sender === "Cleo (AI)" ? "blue" : "black" }}>{msg.sender}</strong>: {msg.message}</p>))}{loadingAI && <p style={{ color: "gray" }}><strong>Cleo (AI)</strong>: Typing...</p>}</div>
